...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'diary', name: 'Diary', component: () => import('@/views/Diary.vue'), meta: { guest: true } },
      ...
      { path: 'admin/announcements', name: 'AdminAnnouncements', component: () => import('@/views/admin/Announcements.vue'), meta: { requiresAdmin: true } },
      { path: 'admin/mails', name: 'AdminSysMail', component: () => import('@/views/admin/SysMail.vue'), meta: { requiresAdmin: true } },
      ...
      { path: 'admin/login-logs', name: 'AdminLoginLogs', component: () => import('@/views/admin/LoginLogs.vue'), meta: { requiresAdmin: true } },
      { path: 'admin/bamboo', name: 'AdminBamboo', component: () => import('@/views/admin/Bamboo.vue'), meta: { requiresAdmin: true } },
      { path: 'admin/config', name: 'AdminConfig', component: () => import('@/views/admin/Config.vue'), meta: { requiresAdmin: true } },
